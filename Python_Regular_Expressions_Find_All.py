...
# understandable.
#
# findall() has to create the entire list before it can be returned as the result. The finditer() method returns a sequence of match object instances as
# an iterator:
# 
...
# OUTPUT: '<callable_iterator object at 0x...>'
